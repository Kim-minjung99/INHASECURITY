...
face_detector = cv2.CascadeClassifier('/home/pi/Desktop/cctv/opencv-master/data/haarcascades/haarcascade_frontalface_default.xml') #여 부분을 파이썬 인터페이스에서 경로참조 해갖고 .xml파일
#참조 했으면 좋겠음
...
while(True):
    ...
    for (x,y,w,h) in faces: #얼굴이 인식되는 동안에는,
